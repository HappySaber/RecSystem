...
func (m *RegisterRequest) validate(all bool) error {
	...
	if !_RegisterRequest_Surname_Pattern.MatchString(m.GetSurname()) {
		err := RegisterRequestValidationError{
			field:  "Surname",
			reason: "value does not match regex pattern \"^[A-Za-z]+( [A-Za-z]+)*$\"",
		}
	...
	if !_RegisterRequest_Role_Pattern.MatchString(m.GetRole()) {
		err := RegisterRequestValidationError{
			field:  "Role",
...
var _RegisterRequest_Name_Pattern = regexp.MustCompile("^[A-Za-z]+( [A-Za-z]+)*$")

var _RegisterRequest_Surname_Pattern = regexp.MustCompile("^[A-Za-z]+( [A-Za-z]+)*$")

var _RegisterRequest_Role_Pattern = regexp.MustCompile("^\\S+$")
...
func (m *IsAdminRequest) validate(all bool) error {
	...
	if !_IsAdminRequest_UserId_Pattern.MatchString(m.GetUserId()) {
...
var _IsAdminRequest_UserId_Pattern = regexp.MustCompile("^\\S+$")
...
func (m *RefreshTokenRequest) validate(all bool) error {
	...
	if !_RefreshTokenRequest_RefreshToken_Pattern.MatchString(m.GetRefreshToken()) {
...
var _RefreshTokenRequest_RefreshToken_Pattern = regexp.MustCompile("^\\S+$")
...
func (m *LogoutRequest) validate(all bool) error {
	...
	if !_LogoutRequest_RefreshToken_Pattern.MatchString(m.GetRefreshToken()) {
...
var _LogoutRequest_RefreshToken_Pattern = regexp.MustCompile("^\\S+$")
