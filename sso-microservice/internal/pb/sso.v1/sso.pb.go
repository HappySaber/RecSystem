...
const file_sso_sso_proto_rawDesc = "" +
	"\n" +
	"\rsso/sso.proto\x12\x04auth\x1a\x17validate/validate.proto\"\xeb\x01\n" +
	...
	"\x04role\x18\x06 \x01(\tB\f\xfaB\tr\a2\x05^\\S+$R\x04role\"+\n" +
	"\x10RegisterResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\"i\n" +
	"\fLoginRequest\x12\x1d\n" +
	"\x05email\x18\x01 \x01(\tB\a\xfaB\x04r\x02`\x01R\x05email\x12#\n" +
	"\bpassword\x18\x02 \x01(\tB\a\xfaB\x04r\x02\x10\x06R\bpassword\x12\x15\n" +
	"\x06app_id\x18\x03 \x01(\x05R\x05appId\"W\n" +
	"\rLoginResponse\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken\"7\n" +
	"\x0eIsAdminRequest\x12%\n" +
	"\auser_id\x18\x01 \x01(\tB\f\xfaB\tr\a2\x05^\\S+$R\x06userId\",\n" +
	"\x0fIsAdminResponse\x12\x19\n" +
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin\"H\n" +
	"\x13RefreshTokenRequest\x121\n" +
	"\rrefresh_token\x18\x01 \x01(\tB\f\xfaB\tr\a2\x05^\\S+$R\frefreshToken\"^\n" +
	"\x14RefreshTokenResponse\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken\"B\n" +
	"\rLogoutRequest\x121\n" +
	"\rrefresh_token\x18\x01 \x01(\tB\f\xfaB\tr\a2\x05^\\S+$R\frefreshToken\"D\n" +
	...
	"\fRefreshToken\x12\x19.auth.RefreshTokenRequest\x1a\x1a.auth.RefreshTokenResponseB(Z&sso-microservice/internal/pb/sso;ssopbb\x06proto3"
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	8, // 2: auth.AuthService.Logout:input_type -> auth.LogoutRequest
	...
	9, // 7: auth.AuthService.Logout:output_type -> auth.LogoutResponse
	5, // 8: auth.AuthService.IsAdmin:output_type -> auth.IsAdminResponse
